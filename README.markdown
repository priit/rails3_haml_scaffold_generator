...
6. Either 
        ...
        git clone git://github.com/priit/rails3_haml_scaffold_generator.git lib/generators/haml

    ...or...

        git submodule add git://github.com/priit/rails3_haml_scaffold_generator.git lib/generators/haml
